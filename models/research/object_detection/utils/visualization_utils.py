...
def visualize_boxes_and_labels_on_image_array(
  ...
  #print("ID: ", category_index[classes[i]]['name'])
  #text_file = open("C:\\tensorflow1\\models\\research\\object_detection\\ID_Detection_Output.txt", "a")
  #for x in range(5):
  #ID_Names = category_index[classes[i]]['name'] + " "                        
  #ID_Names += ID_Names
  #with open("C:\\tensorflow1\\models\\research\\object_detection\\ID_Detection_Output.txt", "a") as oup1:
   # oup1.write(ID_Names)  
  #print(ID_Names)
  #text_file.write(ID_Names)
  #text_file.close()
  return image
